...
void readInputs(){
  ...
  throttle = map(throttle, 0, 4130, 2000, 1000);
  yaw = map(yaw, 0, 4130, 2000, 1000);
  pitch = map(pitch, 0, 4130, 2000, 1000);
  roll = map(roll, 0, 4130, 2000, 1000);

  throttle = throttle + throttleTrim;
  yaw = yaw + yawTrim;
  pitch = pitch + pitchTrim;
  roll = roll + rollTrim;
